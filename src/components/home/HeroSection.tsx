    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-24 pb-32">
        ...
        <motion.h1
          ...
          className="text-center text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight max-w-4xl mx-auto"
        >
         Smart Solar Solutions <br className="hidden sm:block" /> for a <span className="text-white bg-green-400 px-3 sm:px-7">Sustainable Future</span> 
        </motion.h1>
        ...
        {/* Bottom Stats Badges */}
        <div className="mt-10 flex flex-col sm:flex-row justify-between items-center sm:items-end gap-6">
          {/* Left Badge */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6, delay: 0.45 }}
            className="flex items-center gap-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-5 py-4 text-white"
          >
